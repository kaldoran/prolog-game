...
\section{Heuristiques}
	...
	Cette heuristique par du principe que plus le joueur à un grand nombre de pion. Plus ses chances de gagner sont élevée. Ainsi sont but est de manger le plus de pion possible parmi ceux ennemies.
	Cette stratégie est donc purement agressive. Qui plus est, si aucun coup pour manger n'est possible alors l'I.A. essayera de "creuser" un trou dans la défense ennemie en cherchant toujours à avancer vers la possibilitée de faire une dame. \\
	...
	\end{itemize}
	l'I.A. prendra l'option numéro 1, même si sont pions disparait après.
	Ainsi cette stratégie essai de rapprocher l'adversaire de la défaire en mangeant un maximum de ses pions ou a défaut en essayant d'attaquer l'ennemie.
...
L'une des difficultés principale du jeu de dame est sont nombre de coup possible partant d'un plateau de jeu. Ainsi avec une profondeur de 3 ou 4 il est courant de dépasser la pile. \\

Autre remarque, le jeu implique énormément de règle et vérifications qui ont pris énormément de temps.
